...
public final class ThreePieceExperimental{

  /**
   * April Tag field layout.
   */

  private ThreePieceExperimental()
  {
  ...
  public static CommandBase auto(SwerveSubsystem swerve, ArmSubsystem arm, IntakeSubsystem intake, TopRollerSubsystem roller)
  {
      ...
      driveToCube2 = PathPlanner.generatePath(
        ...
        false,
        new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(0)),
        new PathPoint(new Translation2d(3.20, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(0)),
        new PathPoint(new Translation2d(4.50, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(-45)),
        new PathPoint(new Translation2d(4.75, -1.60), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(-45))
      );
        driveBack = PathPlanner.generatePath(
        new PathConstraints(Constants.MAX_SPEED_METERS_PER_SECOND, Constants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED),
        false, 
        new PathPoint(new Translation2d(4.75, -1.60), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(135)),
        new PathPoint(new Translation2d(4.50, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(135)),
        new PathPoint(new Translation2d(3.20, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(0)),
        new PathPoint(new Translation2d(0, 0), Rotation2d.fromDegrees(180), Rotation2d.fromDegrees(0))
